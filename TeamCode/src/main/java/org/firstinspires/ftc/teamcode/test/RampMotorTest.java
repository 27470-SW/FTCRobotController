...
public class RampMotorTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        {
            if(VERBOSE){RobotLog.ee(TAG, "Problem finding left motor");}
        }
        ...
        {
            if(VERBOSE){RobotLog.ee(TAG, "Problem finding right motor");}
        }
        ...
        while(opModeIsActive()) {
            ...
            if(left_drive != null && lex !=null)
            {
               ...
               if(VERBOSE){ RobotLog.dd(TAG, "Power %4.2f LCounts %d", lastPower, curLeft - lastLeft);}
                lastLeft = curLeft;
            }
            if(lex != null)
            {
            ...
            if(right_drive != null && rex != null)
            {
                ...
                if(VERBOSE){RobotLog.dd(TAG, "Power %4.2f RCounts %d", lastPower, curRight - lastRight);}
                lastRight = curRight;
            }
            if(rex != null)
            {
